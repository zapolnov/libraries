...
ILAPI void* ILAPIENTRY ilConvertBuffer(ILuint SizeOfData, ILenum SrcFormat, ILenum DestFormat, ILenum SrcType, ILenum DestType, ILpal *SrcPal, void *Buffer)
{
	...
	#ifdef ALTIVEC_GCC
	auto sizeOfData = iCurImage->SizeOfData;
	#endif
			...
			switch (DestFormat)
			{
				case IL_BGRA:
					...
					switch (DestType)
					{
						...
						case IL_BYTE:
						#ifdef ALTIVEC_GCC
							abcd2cbad_byte(NewData,sizeOfData,NewData);
						#else
						...
						case IL_HALF:
						#ifdef ALTIVEC_GCC
							abcd2cbad_short((ILushort*)Data,sizeOfData,(ILushort*)NewData);
						#else
							for (i = 0; i < NumPix; i += 4) {
								((ILushort*)(NewData))[i] = ((ILushort*)(Data))[i+2];
								((ILushort*)(NewData))[i+1] = ((ILushort*)(Data))[i+1];
						...
						case IL_INT:
						#ifdef ALTIVEC_GCC
							abcd2cbad_int((ILuint*)Data,sizeOfData,(ILuint*)NewData);
						#else
							for (i = 0; i < NumPix; i += 4) {
								((ILuint*)(NewData))[i] = ((ILuint*)(Data))[i+2];
								((ILuint*)(NewData))[i+1] = ((ILuint*)(Data))[i+1];
						...
						case IL_FLOAT:
						#ifdef ALTIVEC_GCC
							abcd2cbad_float(Data,sizeOfData,NewData);
						#else
							for (i = 0; i < NumPix; i += 4) {
								((ILfloat*)(NewData))[i] = ((ILfloat*)(Data))[i+2];
								((ILfloat*)(NewData))[i+1] = ((ILfloat*)(Data))[i+1];
						...
						case IL_DOUBLE:
						#ifdef ALTIVEC_GCC
							abcd2cbad_double((ILdouble*)Data,sizeOfData,(ILdouble*)NewData);
						#else
							for (i = 0; i < NumPix; i += 4) {
								((ILdouble*)(NewData))[i] = ((ILdouble*)(Data))[i+2];
								((ILdouble*)(NewData))[i+1] = ((ILdouble*)(Data))[i+1];
			...
			switch (DestFormat)
			{
				case IL_RGB:
					...
					switch (DestType)
					{
						...
						case IL_DOUBLE:
						#ifdef ALTIVEC_GCC
							abc2cba_double((ILdouble*)Data,sizeOfData,(ILdouble*)NewData);
						#else
							for (i = 0; i < NumPix; i += 3) {
								((ILdouble*)(NewData))[i] = ((ILdouble*)(Data))[i+2];
								((ILdouble*)(NewData))[i+1] = ((ILdouble*)(Data))[i+1];
			...
			switch (DestFormat)
			{
				case IL_RGBA:
					...
					switch (DestType)
					{
						...
						case IL_INT:
						#ifdef ALTIVEC_GCC
							abcd2cbad_int((ILuint*)NewData,sizeOfData,(ILuint*)NewData);
						#else
							for (i = 0; i < NumPix; i += 4) {
								((ILuint*)(NewData))[i] = ((ILuint*)(Data))[i+2];
								((ILuint*)(NewData))[i+1] = ((ILuint*)(Data))[i+1];
						...
						case IL_FLOAT:
						#ifdef ALTIVEC_GCC
							abcd2cbad_float(NewData,sizeOfData,NewData);
						#else
							for (i = 0; i < NumPix; i += 4) {
								((ILfloat*)(NewData))[i] = ((ILfloat*)(Data))[i+2];
								((ILfloat*)(NewData))[i+1] = ((ILfloat*)(Data))[i+1];
